...
- if the product has repeated product, pricing, service, or offer cards, include a focused card family that shows equal-height cards, flexible body layout, and bottom-pinned action rows
...
- repeated card grids must show aligned card heights and action rows; quantity selectors, prices, and primary CTAs should align across cards even when title or description copy lengths vary
